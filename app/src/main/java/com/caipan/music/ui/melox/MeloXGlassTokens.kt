 ...
 * (app/src/main/java/com/ljyh/mei/ui/glass/GlassTokens.kt).
 *
...
object IosTypography {
    /*
     * WARNING - not open source: R.font.sf_pro is Apple's SF Pro
     * (res/font/sf_pro.ttf, "2015-2025 Apple Inc."). Apple's font license only
     * permits using it for interface mock-ups targeting Apple platforms and
     * explicitly forbids embedding it in shipped software products.
     * Replace it with a freely redistributable family (Inter, Roboto Flex, ...)
     * before publishing public builds. See THIRD_PARTY_NOTICES.md section 2.
     */
    val fontFamily = FontFamily(Font(R.font.sf_pro))
...
val LocalMergedGlassCards = staticCompositionLocalOf { false }
