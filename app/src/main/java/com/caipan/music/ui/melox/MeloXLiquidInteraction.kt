/*
 * Liquid glass drag interaction primitives
 *
 * Ported from NEORUAA/Mei_MeloX_Android
 * (ui/liquidglass/DampedDragAnimation.kt, DragGestureInspector.kt,
 * InteractiveHighlight.kt). DragGestureInspector is derived from
...
class DampedDragAnimation(
    ...
    val pressProgressState: State<Float> = pressProgressAnimation.asState()
    val pressProgress: Float get() = pressProgressState.value
...
class InteractiveHighlight(
    ...
    // 当前 backdrop 版本不提供 RuntimeShader 的 Compose ShaderBrush 桥接，
    // 使用官方文档中为不支持设备准备的纯色回退效果。
